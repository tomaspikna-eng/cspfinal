...
function tournamentResultCard(t){
  const position=Number(t.final_position),played=Number(t.matches_played)||0,wins=Number(t.wins)||0,losses=Number(t.losses)||0;
  const scoreFor=Number(t.score_for)||0,scoreAgainst=Number(t.score_against)||0;
